...
{
    public GameObject ShellPrefab;        // 포대에서 발사되는 포탄 Prefab
    ...
    {
        // 발사구 오브젝트 얻기
        Transform tr = transform.Find("Cannon_gate");
    ...
    void Update()
    {
        ...
        if (CheckLength(player.transform.position))
        {
            if (passedTimes > delayTime)
            {
                ...
                GameObject obj = Instantiate(ShellPrefab, pos, Quaternion.identity);
                // 발사 방향
